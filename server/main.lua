...
RegisterServerEvent('esx_policejob:AddRifle')
AddEventHandler('esx_policejob:AddRifle', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
...
RegisterServerEvent('esx_policejob:AddSniperRifle')
AddEventHandler('esx_policejob:AddSniperRifle', function()
	local _source = source
	local xPlayer = ESX.GetPlayerFromId(_source)
